...
import com.example.visionpro.data.*
        ...
        cropRegion?.run {
            ...
            inputTensor?.let { input ->
                ...
                for (idx in 0 until numKeyPoints) {
                    Log.i("keypoints_test", "inputWidth:"+inputWidth+" widthRatio:"+widthRatio+" inputHeight:"+inputHeight+" heightRatio:"+heightRatio)
